            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 text-justify">
                  <b>RTPEA</b> is a database available publically which hosts data
                  generated by RetroMiner. It is a database that can be accessed
                  using our API and explored interactively.
                  <br />
                  <b>RetroMiner</b> uses unbiased proteomic approaches to reanalyse
                  PRIDE datasets to detect and identify retroelement proteins.
