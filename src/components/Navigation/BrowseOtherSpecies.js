          ...
          >
            ...
            <div
              style={{
                width: `${row.value}%`,
                height: '100%',
                backgroundColor: row.value > 80 ? this.props.high_conf_colour
                  : row.value > 40 ? this.props.med_conf_colour
  ...
  accessor: '-'
      ...
      return (
        <div>
          ...
          <div className="col-md-10 offset-md-1" style={{background: this.props.background_colour, color: this.props.text_colour}}>
          <br />
            <ReactTable
